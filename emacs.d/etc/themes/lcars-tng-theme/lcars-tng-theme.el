...
(defvar atom-one-dark-colors-alist
  '(("atom-one-dark-accent"   . "#9966ff") ;set
    ("atom-one-dark-fg"       . "#FFCC99") ;set
    ("atom-one-dark-bg"       . "#0E0E0E") ;set
    ("atom-one-dark-bg-1"     . "#46698C") ;set
    ("atom-one-dark-bg-hl"    . "#5986B2") ;set
    ("atom-one-dark-mono-1"   . "#B8B8E5") ;set
    ("atom-one-dark-mono-2"   . "#9999BF") ;set
    ("atom-one-dark-mono-3"   . "#66667F") ;set
    ("atom-one-dark-cyan"     . "#99CCFF") ;set
    ("atom-one-dark-blue"     . "#9999FF") ;set
    ("atom-one-dark-purple"   . "#CC99CC") ;set
    ("atom-one-dark-green"    . "#98C379") ;set
    ("atom-one-dark-red-1"    . "#CC6699") ;set
    ("atom-one-dark-red-2"    . "#CC6666") ;set
    ("atom-one-dark-red-3"    . "#FF3300") ;set
    ("atom-one-dark-orange-1" . "#FF9900") ;set
    ("atom-one-dark-orange-2" . "#FF9966") ;set
    ("atom-one-dark-gray"     . "#999999") ;set
    ("atom-one-dark-silver"   . "#CCCCFF") ;set
    ("atom-one-dark-black"    . "#000000")) ;set
...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(warning ((t (:foreground ,atom-one-dark-red-3))))
   ...
   `(font-lock-string-face ((t (:foreground ,atom-one-dark-purple))))
   `(font-lock-type-face ((t (:foreground ,atom-one-dark-orange-1))))
   `(font-lock-constant-face ((t (:foreground ,atom-one-dark-orange-1))))
   `(font-lock-variable-name-face ((t (:foreground ,atom-one-dark-red-2))))
